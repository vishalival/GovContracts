...
Triggers a regulatory alignment check that compares internal NAICS code tables against an official snapshot. Writes results to `backend/data/alignment_report.json`, `docs/ALIGNMENT_REPORT.md`, and `docs/ALIGNMENT_PROPOSAL.md`.
...
```json
{
  ...
  "generated_at": "2026-02-24T03:00:00+00:00",
  "files_written": {
...
Returns the most recent alignment report previously generated by `POST /internal/alignment/run`.
...
```json
{
  ...
  "report": {
    ...
    "naics": {
      "added": [
        { "code": "999100", "official_description": "Example Added Industry", "contracts_affected": 0 }
      ],
      "removed": [
        { "code": "999200", "internal_description": "Deprecated Industry", "contracts_affected": 1 }
      ],
      "modified": [
        { "code": "541511", "internal_description": "Old Description", "official_description": "Updated Description", "contracts_affected": 3 }
      ]
    },
    "summary": {
      "naics_added": 2,
