        ...
        <div className="space-y-5 p-5 text-sm text-gray-700">
          <section>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <div>PSC: {contract.psc}{contract.psc_description ? ` - ${contract.psc_description}` : ""}</div>
              <div>NAICS: {contract.naics}{contract.naics_description ? ` - ${contract.naics_description}` : ""}</div>
